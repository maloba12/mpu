        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                if ($stmt->fetch()) {
                    ...
                    $insert_query = 'INSERT INTO users (username, email, password, full_name, created_at) VALUES (:username, :email, :password, :full_name, NOW())';
                    ...
                    if ($stmt->execute()) {
                        // Registration successful - set session message and redirect to login
